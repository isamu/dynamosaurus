...
describe Dynamosaurus::DynamoBase do
  ...
  it 'simple ordered kvs test' do
    expect(Dynamosaurus::DynamoBase.all_models).to match_array [DynamoModelWithoutTableField, DynamoModelWithTableField, Comment, SimpleOrderedKVS, SimpleKVS]
    expect(Dynamosaurus::DynamoBase.tables).to match_array  ["comment_local", "dynamomodelwithouttablefield_local", "simplekvs_local", "simpleorderedkvs_local", "table_name"]
